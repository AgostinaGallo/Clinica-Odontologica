...
@WebServlet(name = "editTurnoServlet", urlPatterns = {"/editTurnoServlet"})
public class editTurnoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        control.editarTurno(id_turno, motivo, fecha, horario, doctor, paciente, estado, observaciones);
