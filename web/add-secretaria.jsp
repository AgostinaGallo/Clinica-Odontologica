                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <h4 class="page-title">Agregar Secretaria</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="addsecretariaServlet" method="post">
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn">Crear Secretaria</button>
                                </div>
                            </form>
                        </div>
                    </div>
