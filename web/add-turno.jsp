        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="addturnoServlet" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Motivo de Turno</label>
                                            <input type="text" class="form-control" name="motivo" placeholder="Ingrese el motivo de este turno..." required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="observaciones" placeholder="Observaciones del turno..." rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn">Crear Turno</button>
                                </div>
                            </form>
                        </div>
                    </div>
