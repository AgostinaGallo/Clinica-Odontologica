                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    <li><a href="#">Atendidos por Día</a></li>
                                    <li><a href="#">Turnos de Doctor por Día</a></li>
                                    <li><a href="#">Pacientes con/sin Cobertura</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-9 text-right m-b-20">
                            <a href="add-doctor.jsp" class="btn btn-success btn-rounded float-right"><i class="fa fa-plus"></i> Agregar Doctor</a>
                        </div>
                    </div>
                    <div class="row doctor-grid">
                        <%
                            ...
                            for (Doctor doc : listaDoctores) {
                                String id_doctor = Integer.toString(doc.getId_doctor());
                        %>
                        <div class="col-md-4 col-sm-4  col-lg-3">
                            <div class="profile-widget">
                                <div class="doctor-img">
                                    <a class="avatar" href="profile.jsp"><img alt="" src="assets/img/user.jpg"></a>
                                </div>
                                <div class="dropdown profile-action">
                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="edit-doctor.jsp?id_doctor=<%=id_doctor%>" name="id_doctor"><i class="fa fa-pencil m-r-5"></i> Editar</a>
                                        <a class="dropdown-item" href="borrarDoctorServlet?id_doctor=<%=id_doctor%>" data-toggle="modal" data-target="#BORRAR-<%=id_doctor%>"><i class="fa fa-trash-o m-r-5"></i> Borrar</a>
                                    </div>
                                </div>
                                <h4 class="doctor-name text-ellipsis"><a href="profile.html"><%=doc.getNombre() + " " + doc.getApellido()%></a></h4>
                                <div class="user-country">
                                    <i class="fa fa-plus-circle"></i> <%=doc.getEspecialidad()%>
                                </div>
                                <div class="doc-prof">DNI: <%=doc.getDni()%></div>
                                <div class="doc-prof">Sexo: <%=doc.getSexo()%></div>
                                <div class="doc-prof">Dirección: <%=doc.getDireccion()%></div>
                                <div class="doc-prof">Teléfono: <%=doc.getTelefono()%></div>
                                <div class="doc-prof">Email: <%=doc.getEmail()%></div>
                                <div class="doc-prof">Fecha de Nacimiento: <%=control.DateToString(doc.getFecha_nacimiento())%></div>
                                <div class="doc-prof">Ciudad: <%=doc.getCiudad()%></div>
                                <div class="doc-prof">Provincia: <%=doc.getProvincia()%></div>
                                <!--MODAL-->
                                <div id="BORRAR-<%=id_doctor%>" class="modal fade delete-modal" role="dialog">
                                    <form action="borrarDoctorServlet"  method="get">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body text-center">
                                                    <img src="assets/img/sent.png" alt="" width="50" height="46">
                                                    <h3>¿Seguro de borrar este Doctor?</h3>
