                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <%
                                ...
                                Doctor doc = control.getDoctorById(id_doctor);
                            %>
                            <h4 class="page-title">Editar Doctor Nro.: <%=id_doctor%></h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="editDoctorServlet" method="post">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="dni" aria-describedby="basic-addon2" name="dni" required value="<%=doc.getDni()%>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="nombre" aria-describedby="basic-addon2" name="nombre" required value="<%=doc.getNombre()%>">
                                            </div>
                                        </div>
                                        <label class="col-form-label col-lg-1">Apellido/s</label><!-- APELLIDO -->
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="apellido" aria-describedby="basic-addon2" name="apellido" required value="<%=doc.getApellido()%>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="direccion" aria-describedby="basic-addon2" name="direccion" required value="<%=doc.getDireccion()%>">
                                            </div>
                                        </div>
                                        <label class="col-form-label col-lg-2">Fecha de Nacimiento</label><!-- FECHA NACIMIENTO -->
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="date" name="fecha_nacimiento" required value="<%=control.DateToString(doc.getFecha_nacimiento())%>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="telefono" aria-describedby="basic-addon2" name="telefono" required value="<%=doc.getTelefono()%>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control" aria-label="email" aria-describedby="basic-addon1" name="email" required value="<%=doc.getEmail()%>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="ciudad" aria-describedby="basic-addon2" name="ciudad" required value="<%=doc.getCiudad()%>">
                                            </div>
                                        </div>
                                        <label class="col-form-label col-lg-1">Provincia</label><!-- PROVINCIA -->
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" aria-label="provincia" aria-describedby="basic-addon2" name="provincia" required value="<%=doc.getProvincia()%>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group center">
                                                <select name="especialidad" class="form-control">
                                                    <option value="<%=doc.getEspecialidad()%>" selected><%=doc.getEspecialidad()%></option>
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn">Actualizar Doctor</button>
                                </div>
                            </form><!-- /form -->
                        </div>
                    </div>
